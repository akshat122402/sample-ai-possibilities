"""Local test for the DEF agent — phases, fallback, role whitelist, parsing.

    python3 ai-def/test_local.py           # offline
    python3 ai-def/test_local.py --llm     # adds one real Bedrock call
"""
...
def test_llm():
    ...
    try:
        ...
        agent = Agent(model=BedrockModel(model_id="us.amazon.nova-lite-v1:0"), system_prompt=SYSTEM_PROMPT)
