"""Local test for the ML agent — phases, fallback, role whitelist, parsing.

    python3 ai-ml/test_local.py           # offline
    python3 ai-ml/test_local.py --llm     # adds one real Bedrock call
"""
